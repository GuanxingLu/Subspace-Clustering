...
3. A [comparision demo](demo_parallel.m) of the mentioned methods (you may need to implement them yourself, or refer to the possible official implementation) in our manuscript, including LRR, DPLRR, SSLRR, L-RPCA, CP-SSC, SC-LRR and CLRR.
