...
%fn = [filename,'_demo_1130_LabelSelect.mat'];
...
figure
%p1 = plot(100*Data.testset_p,Data.err_p_rec,'->','LineWidth',1.2);
%hold on
...
hold on
plot(100*Data.testset_p,Data.err_p_lrpca,'->','LineWidth',1.2);
hold on
...
figure
%p11 = plot(100*Data.testset_p,Data.nmi_p_rec,'->','LineWidth',1.2);
%hold on
...
hold on
plot(100*Data.testset_p,Data.nmi_p_lrpca,'->','LineWidth',1.2);
hold on
